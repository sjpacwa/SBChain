...
class Transaction:
    def __init__(self, sender, inputs, outputs, uuid=None):
    ...
    def to_json(self):
        return {
            ...
            'outputs': {recipient:[coin.to_json() for coin in outputs[recipient]] for recipient in self._outputs},
